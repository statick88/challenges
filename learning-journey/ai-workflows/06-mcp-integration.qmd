...
**Model Context Protocol** es un protocolo abierto que permite [@anthropic2025mcp]:
...
### 2. Engram (Memoria Persistente) {#engram}

**Propósito**: Memoria a largo plazo entre sesiones [@engram2025memory]

> "Your AI coding agent forgets everything when the session ends. Engram gives it a brain."
> 
> — Gentleman Programming [@engram2025brain]
>
...
>
> — Gentleman Programming [@engram2025memory]
...
### 3. Context7 (Documentación Actualizada) {#context7}

**Propósito**: Fetch de documentación actualizada [@context7docs]
...
### Kilocode: `~/.kilocode/mcp.json` {#kilocode-mcp}
...
1. **MCP** conecta IA con herramientas externas [@anthropic2025mcp]
2. **spec-coding-mcp** estructura especificaciones
3. **Engram** persiste memoria entre sesiones [@engram2025memory]
4. **Context7** mantiene documentación actualizada [@context7docs]
...
Continúa con [Módulo 7: Patrones Avanzados](07-advanced-patterns.qmd) para aplicar SDD en escenarios complejos.
