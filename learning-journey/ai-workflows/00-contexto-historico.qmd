...
> — Simon Willison [@willison2025vibe]
...
1. **60 años de abstracción** han llevado a la programación de assembly a specs
2. **SQL demostró** que la programación declarativa funciona en dominios específicos
3. **MDD y 4GL** fallaron por falta de flexibilidad según la literatura
4. **Vibe Coding** presenta velocidad pero riesgo para producción [@karpathy2025vibe]
5. **SDD** es la evolución natural: especificaciones como "North Star" [@brooker2025kiro]
6. **No es binario**: La evidencia muestra un espectro de opciones según el contexto
