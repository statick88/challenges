...
- Böckeler, B. (2025). "Understanding Spec-Driven Development" - Martin Fowler
- Brooker, M. (2025). "Kiro and the Future" - AWS
- Delimarsky, D. (2025). "Spec Kit" - Microsoft
- Precursor Manifesto (2025). "Context Architecture"
- StrategyRadar.ai (2025). "Task-Driven Development with AI"

### Estadísticas

- Y Combinator Winter 2025: 25% startups con 95% código IA
- ArXiv studies on LLM code quality
- GitHub research on AI-assisted development

---

*Curso v3.0 | Actualizado: 2026-02-24 | Autor: Gentleman Programming*
