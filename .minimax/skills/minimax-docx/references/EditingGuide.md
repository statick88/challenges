...
Complete reference for `core.markup`. **For simple edits only** (comments, track changes, minor text fixes).

⚠️ **For complex edits** (restructure, restyle, large changes): Use C# + OpenXML SDK. Treat as creating a new document.
